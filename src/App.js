...
function App() {
  const transferTransaction = async () => {
    ...
    const operatorKey = PrivateKey.fromStringECDSA("3030020100300706052b8104000a042204208c4ffe487636e8102f72502a2ed16cb4f98073582a777fcfa758481485d9f887");

    /**
     * 2. Create a custom newtork with GRPC web proxies
     */
    const nodes = {
  ...
  useEffect(() => { // triggers the transaction when the page is loaded
    transferTransaction();
  }, []);
